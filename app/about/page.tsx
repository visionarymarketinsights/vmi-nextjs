                            ...
                            <div className="text-gray-700">
                                ...
                                <div className="mb-2 ">
                                    <div className='flex-wrap justify-center py-2 md:flex'>
                                        <div className='px-4 py-4 text-center md:w-1/3'>
