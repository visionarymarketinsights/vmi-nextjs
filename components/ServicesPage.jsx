                ...
                <div className="max-w-screen-xl p-6 mx-auto">
                    <div className="items-center gap-80 lg:grid lg:grid-cols-2 xl:gap-16">
                        <div className=" sm:text-lg -400">
                            <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 ">Market Intelligence</h2>
                            <p className="mb-2 text-sm font-normal text-black">Market Intelligence are crucial in turning companies into modern, data-driven organizations, empowering their daily reporting, operations, and insights sharing. We offer our expertise and Market Intelligence services to assess the business environment with respect to external and internal factors and enable strategic decision-making. Our, Market Intelligence solutions provide actionable insights into various business-critical factors and custom research for informed decision-making.Our services equip and help clients with actionable insights on:</p>
                            <ul role="list" className="space-y-5 my-7 -700">
                                ...
                                <li className="flex space-x-3">
                                    ...
                                    <span className="text-base font-medium leading-tight text-gray-900 ">
                                        ...
                                        Market forecast & demand-supply situatio</span>
                                </li>
                                <li className="flex space-x-3">
                                    <svg className="flex-shrink-0 w-5 h-5 text-purple-500 -400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                                    <span className="text-base font-medium leading-tight text-gray-900 ">
                                        Drivers & Restraints of busines</span>
                                </li>
                                <li className="flex space-x-3">
                                    <svg className="flex-shrink-0 w-5 h-5 text-purple-500 -400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                                    <span className="text-base font-medium leading-tight text-gray-900 ">
                                        Opportunity assessment using TAM – Total Addressable Marke</span>
                                </li>
                                <li className="flex space-x-3">
                                    <svg className="flex-shrink-0 w-5 h-5 text-purple-500 -400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                                    <span className="text-base font-medium leading-tight text-gray-900 ">
            ...
            <div className='m-4 p-2 md:p-8 border border-slate-200 rounded-md bg-[#f7f7f7]'>
                ...
                <section id='section-3' className="mb-4 bg-white rounded-md shadow-lg">
                    <div className="max-w-screen-xl p-6 mx-auto">
                        <div className="items-center gap-8">
                            <div className=" sm:text-lg -400">
                                <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 ">Macro-Economic Analysis</h2>
                                <p className="mb-2 text-sm font-normal text-black">Macroeconomic volatility and related structural changes (e.g. disruptions in the supply chain) translate into increased uncertainty in business planning across many industries. Our analyses help Clients to be up-to-date with macroeconomic trends as well as to understand whether and how macroeconomic factors affect their key business metrics. We undertake bespoke projects commissioned by companies, government agencies, and trade associations, producing the detailed, substantive research they need to present to investors and shareholders. <br /><br /> Our macroeconomics consulting team has a long record of applying economic tools in new and innovative ways, providing evidence-based insights to support strategic and business planningOur Macro- Economic Advisors track daily GDP tracking, monetary policy, and fixed income markets of leading global superpower countries. They quantify various policy options considered by the governments and perform scenario analysis to enable financial institutions, companies and industries to comply with regulatory requirements. The combination of Macroeconomic Advisers with our own global analyst teams will allow Visionary Market Dynamics to provide unparalleled coverage to our customers with a keen focus on policy and financial markets.</p>
                            </div>
                            {/* <img loading="lazy" className="hidden w-full mb-4 rounded-lg shadow-md lg:mb-0 lg:flex" src={'/assets/others/consulting2.webp'} alt="dashboard feature image" /> */}
                        </div>
                    </div>
