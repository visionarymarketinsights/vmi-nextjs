            ...
            <section id='section-1' className="bg-gray-50">
                <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-12 lg:px-6">
                    <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        ...
                        <img loading="lazy" className="hidden w-full mb-4 rounded-lg shadow-md lg:mb-0 lg:flex" src='/assets/vmi/services/Market Intelligence.jpg' alt="dashboard feature image" />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-12 lg:px-6">
                    <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        <div className="text-gray-500 sm:text-lg -400">
                            ...
                            <p className="mb-2 text-sm font-light">Macroeconomic volatility and related structural changes (e.g. disruptions in the supply chain) translate into increased uncertainty in business planning across many industries. Our analyses help Clients to be up-to-date with macroeconomic trends as well as to understand whether and how macroeconomic factors affect their key business metrics. We undertake bespoke projects commissioned by companies, government agencies, and trade associations, producing the detailed, substantive research they need to present to investors and shareholders. Our macroeconomics consulting team has a long record of applying economic tools in new and innovative ways, providing evidence-based insights to support strategic and business planningOur Macro- Economic Advisors track daily GDP tracking, monetary policy, and fixed income markets of leading global superpower countries. They quantify various policy options considered by the governments and perform scenario analysis to enable financial institutions, companies and industries to comply with regulatory requirements. The combination of Macroeconomic Advisers with our own global analyst teams will allow Visionary Market Dynamics to provide unparalleled coverage to our customers with a keen focus on policy and financial markets.</p>
                        </div>
                        <img loading="lazy" className="hidden w-full mb-4 rounded-lg shadow-md lg:mb-0 lg:flex" src={'/assets/others/consulting2.webp'} alt="dashboard feature image" />
                    </div>
                </div>
