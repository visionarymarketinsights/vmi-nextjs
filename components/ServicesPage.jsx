            ...
            <section id='section-1' className="bg-gray-50">
                <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-12 lg:px-6">
                    <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        ...
                        <img loading="lazy" className="hidden w-full mb-4 rounded-lg shadow-md lg:mb-0 lg:flex" src='/assets/vmi/services/Market Intelligence.webp' alt="dashboard feature image" />
                    </div>
                </div>
            </section>
