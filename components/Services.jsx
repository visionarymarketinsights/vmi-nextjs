...
export default function Services() {
    return (
        <div className='relative overflow-clip'>
            ...
            <img loading="lazy" className='absolute top-0 object-cover w-full h-full' src={'/assets/vmi/bgn5.jpg'} alt="bg-banner-img" srcSet="" />
                ...
                <div className="pt-12 md:py-12 md:pt-10">
                    <div className="pb-12 mx-auto text-center md:pb-0">
                        ...
                        <div className='flex justify-center mb-8 text-sm text-white'>
                            ...
                            <button type="button" className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold transition-all bg-white border border-transparent rounded-md text-cyan-800 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:ring-offset-2">
                                Browse All Services
                            </button>
                            </div>
                        </motion.div>
