...
export const getClientEmail = (clientName) => {
    return (
        `Hi ` + clientName + `,<br><br>Hope you are well.<br>Thanks you for your inquiry.<br>Yes, will share the sample report shortly with you. <br>Can you confirm the actual requirement so that we can share the scope of the report in sample itself. <br>Appreciate your soonest response.<br><br>Best regards,<br>Visionary Market Insights`
    )
}
